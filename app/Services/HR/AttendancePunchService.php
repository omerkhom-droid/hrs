...
class AttendancePunchService
{
        ...
        try {
            ...
            return DB::transaction(
                function () use (
                    ...
                    /*
                     * يمنع الحضور أثناء الإجازة المعتمدة.
                     * أما سجل العطلة فيسمح بتحويله إلى
                     * سجل عمل في عطلة.
                     */
                    if (
                        !$reusedArchivedRecord &&
                        ...
                        throw new LogicException(
                            'لا يمكن تسجيل الحضور لأن اليوم مسجل كإجازة.'
                        );
                    }
                    ...
                    $metadata = array_filter([
                        ...
                        'check_in_camera_facing' =>
                            $data[
                                'camera_facing'
                            ] ?? null,

                        'holiday' =>
                            $this->holidayMetadata(
                                $context,
                                true
                            ),
                    ], fn ($value) =>
    ...
    */
    ...
    public function today(
        ...
        /*
         * يوم العطلة يسمح بالتسجيل حتى إذا
         * لم يكن ضمن أيام الوردية الأسبوعية.
         */
        $isWorkDay =
            $isHoliday ||
            $this->isWorkDay(
    ...
    */
    ...
    private function ensureValidSource(
        string $source
    ): void {
        if (
            !in_array(
    ...
    private function ensureWorkDay(
        ...
        /*
         * يسمح بالعمل في العطلة حتى إذا لم تكن
         * ضمن أيام الوردية الأسبوعية.
         */
        if ($isHoliday) {
            return;
        }
    ...
    */
    ...
    private function validateGeofence(
        ...
        if (
            ...
            throw new LogicException(
                'دقة الموقع غير كافية لتسجيل البصمة. الدقة الحالية ' .
                (
                    $accuracy === null
                        ? 'غير معروفة'
                        : round(
