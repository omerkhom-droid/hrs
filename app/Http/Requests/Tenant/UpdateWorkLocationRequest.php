...
class UpdateWorkLocationRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('work_locations.update') ?? false;
    }
    ...
    protected function prepareForValidation(): void
    {
        ...
        $currentStatus = $workLocation instanceof WorkLocation
            ? $workLocation->is_active
            : true;

        $currentTimezone = $workLocation instanceof WorkLocation
            ? $workLocation->timezone
            : ($this->user()?->tenant?->timezone
    ...
    public function rules(): array
    {
        ...
        $workLocationId = $workLocation instanceof WorkLocation
            ? $workLocation->getKey()
            : (int) $workLocation;
